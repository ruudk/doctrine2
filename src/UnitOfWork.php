...
class UnitOfWork implements PropertyChangedListener
{
    ...
    /** @var array<string, array{items: array<string, PersistentCollection<array-key, object>>, mapping: ToManyAssociationMapping}> */
                ...
                default:
                    ...
                    if ($hints['fetchMode'][$class->name][$field] === ClassMetadata::FETCH_EAGER) {
                        if (
                            ...
                            && $this->associationBatchLoader->canBatchLoad($assoc)
                        ) {
