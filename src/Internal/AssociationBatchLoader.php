...
final class AssociationBatchLoader
{
     ...
     */
    public function canBatchLoad(ToManyAssociationMapping $mapping): bool
    {
     ...
     */
    public function loadCollections(array $collections, ToManyAssociationMapping $mapping): void
    {
        if ($collections === []) {
            return;
        }
    ...
    private function loadOneToManyCollections(array $collections, ToManyInverseSideMapping $mapping): void
    {
     ...
     * @param array<string, PersistentCollection<array-key, object>> $collections
     */
    private function loadManyToManyCollections(array $collections, ManyToManyAssociationMapping $mapping): void
    {
        $joinColumns = $this->manyToManyJoinColumns($mapping);
        ...
        assert($owningMapping instanceof ManyToManyAssociationMapping);
     ...
     * @param array<string, PersistentCollection<array-key, object>> $collections
     *
     * @return list<array{doctrine_source: mixed, doctrine_target: mixed}>
     */
     ...
     */
    private function manyToManyJoinColumns(ToManyAssociationMapping $mapping): array|null
    {
    ...
    {
        return $this->em->getConfiguration()->getEagerFetchBatchSize();
    }
}
